...

{
    ...
    {
        // Waffen (w)
        Weapon weapon0 = new Weapon("Langschwert", "inst wurde dieses Schwert von den Kriegern der Feuernation geschwungen. Doch jetzt liegt es in Euren Händen. Möge es Euch gute Dienste leisten!", "(Ungewöhnlich)", "neutrum", 5);
        Weapon weapon1 = new Weapon("Holzstock", "Abgebrochen von einer alten Buche ist er keine besonders starke Waffe. Aber besser als nichts. Am besten betest Du nicht angegriffen zu werden.", "(Gewöhnlich)", "maskulin", 1);
        Weapon weapon2 = new Weapon("Streitaxt" , "Geschmiedet in den Küstenregionen im Norden ist diese zweischneidige Axt äußerst robust. Ihre mystischen Verziehrungen stellen nordische Götter dar, die Dir im Kampf beistehen. Durch die Klingen auf beiden Seiten ist sie besonders gut für den Kampf gegen mehrere Gegner geeignet.", "(Gewöhnlich)", "feminin", 3);
        Weapon weapon3 = new Weapon("Dolch" , "Geschmiedet in den Schattenschmieden der Assasinen ist dieser kleine Dolch leicht zu verstecken und eignet sich hervorragend für Angriffe aus dem Hinterhalt.", "(Selten)", "maskulin", 2);
        Weapon weapon4 = new Weapon("Speer", "Dieser schlichte Speer ist trotz seiner simplen Erscheinung eine sehr starke und effektive Waffe. Durch den langen Stiehl ist er gut geignet um Gegner auf Distanz zu halten.", "(Selten)", "maskulin", 4);
        Weapon weapon5 = new Weapon("Katana", "Dieses Schwert aus den östlichen Regionen wurde mit viel Mühe aus mehreren Schichten harten Stahls geschmiedet. Die mit einem furchteinflößenden Drachen verzierte Tsuba schützt deine Hände. Diese äußerst scharfe und gut ausbalancierte Schwert eignet sich sehr für schnelle und tödliche Angriffe.", "(Legendär)", "neutrum", 8);
