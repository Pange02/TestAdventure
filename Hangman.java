 ...
 */
public class Hangman extends Boss
{
     ...
     */
    public Hangman(String parsename, int parselevel, int parsehealth, Weapon parseweapon, ArrayList parsemobloot, int parsemobxp, String parsegender)
    {
    ...
    // Hinzufügen der Spezialangriffe (Doppenangriff und Schild)
